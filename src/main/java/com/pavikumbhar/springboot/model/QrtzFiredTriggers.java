...
public class QrtzFiredTriggers  implements java.io.Serializable {
    ...
    public QrtzFiredTriggers(QrtzFiredTriggersId id, String triggerName, String triggerGroup, String instanceName, long firedTime, long schedTime, long priority, String state) {
        this.id = id;
    ...
    public QrtzFiredTriggers(QrtzFiredTriggersId id, String triggerName, String triggerGroup, String instanceName, long firedTime, long schedTime, long priority, String state, String jobName, String jobGroup, String isNonconcurrent, String requestsRecovery) {
       this.id = id;
       this.triggerName = triggerName;
       this.triggerGroup = triggerGroup;
       this.instanceName = instanceName;
    ...
    @Column(name="SCHED_TIME", nullable=false, precision=13, scale=0)
