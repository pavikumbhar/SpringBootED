...
public class InitializingCronTrigger implements FactoryBean<CronTrigger>, BeanNameAware, InitializingBean {
	...
	public void afterPropertiesSet() throws ParseException {
	       System.out.println("############################ beanName "+beanName);
             System.out.println("AAAAAA"+shedulerService.getCronExpressionFromDB(beanName));
            if (this.name == null) {
		...
		cti.setStartTime(this.startTime);
                ...
                {
                   cti.setCronExpression(shedulerService.getCronExpressionFromDB(name));
